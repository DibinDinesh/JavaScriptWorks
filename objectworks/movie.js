...
// movie whose runtime below 140--------------------------------------------------------------

// var runtimeFilter=filims.filter(fi=> fi.runtime < 140).map(fi=> fi.title)
// console.log(runtimeFilter)

// movie with highest runtime-------------------------------------------------------------------

// var highestRuntime=filims.reduce((p1,p2)=>  parseInt(p1.runtime) > parseInt(p2.runtime) ? p1 : p2)
// console.log("Movie with the highest runtime:",highestRuntime.id);

// ==============OR======================

// var highestRuntimeMovie=filims.reduce((m1,m2)=> Number(m1.runtime) > Number(m2.runtime) ? m1 : m2)
// console.log(highestRuntimeMovie.title);



// movie with lowest runtime-------------------------------------------------------------------

// var lowestRuntime=filims.reduce((p1,p2)=> parseInt(p1.runtime) < parseInt(p2.runtime) ? p1 : p2)
// console.log("Movie with the lowest runtime:",lowestRuntime.id);

// yearwise movie count----------------------------------------------------------------------------

// var wc={}
//     for (let ch of filims){
//         if (ch .year in wc){
//             wc[ch.year]++;
...
// var actionMovienames=filims.filter(p=> p.genres.includes("Action")).map(p=> p.title)
// console.log(actionMovienames);

// movie with genres either action or drama----------------------------------------------------------------
